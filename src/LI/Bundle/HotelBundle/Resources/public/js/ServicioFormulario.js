...
var $addTagLink2 = $('<button style="margin-top: 10px;" class="btn btn-success btn-sm btn-block" type="button" href="#" class="add_tag_link">Agregue un servicio</button>');
...
jQuery(document).ready(function() {
    ...
    $collectionHolder2.children().append(
        '<a href="#" class="remove-tag btn btn-danger btn-sm btn-block">Quitar este servicio</a>');
...
function addTagForm($collectionHolder2, $newLinkLi2) {
    ...
    $newFormLi.append('<a href="#" class="remove-tag btn btn-danger btn-sm btn-block">Quitar Servicio</a>');
